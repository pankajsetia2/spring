...
dojo.declare("insight.charting.action2d.StrokeHighlight",dojox.charting.action2d.Base,{defaultParams:{duration:400,easing:dojo.fx.easing.backOut},optionalParams:{highlight:"red"},constructor:function(_6,_7,_8){
...
var _f=o.shape.getStroke().color;
...
_c.action=dojox.gfx.fx.animateStroke({shape:o.shape,duration:this.duration,easing:this.easing,color:{start:_10,end:end}});
if(o.type=="onmouseout"||o.originalEvent=="onmouseout"){
